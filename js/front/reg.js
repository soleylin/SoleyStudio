...
$(function () {
  ...
  $("#reg_acc").bind("input propertychange", function () {
    if ($(this).val().length > 4 && $(this).val().length < 16) {
      ...
      $.ajax({
        type: "POST",
        url: "http://https://soleystudio.000webhostapp.com/api/member/acc-CheckUni.php",
  ...
  $("#reg_tel").bind("input propertychange", function () {
    if ($(this).val().length == 10 && $(this).val().substr(0, 2) == "09") {
      ...
      $.ajax({
        type: "POST",
        url: "http://https://soleystudio.000webhostapp.com/api/member/tel-CheckUni.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
  ...
  $("#reg_ok_btn").click(function () {
    if (
      ...
      $.ajax({
        type: "POST",
        url: "http://https://soleystudio.000webhostapp.com/api/member/member-Create.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
        success: showdata,
        error: function () {
