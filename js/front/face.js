...
function drawdata(page) {
  ...
  newData[page].forEach(function (item) {
    var strHTML =
      '<div class="col-md-6 col-xl-4"><div class="s2_box ms-auto me-auto"><div class="s2_bgbox"></div><div class="s2_img"><img src="https://soleylin.github.io/SoleyStudio/image/admin/product/' +
      item.image +
...
function read(itemName) {
  ...
  $.ajax({
    type: "POST",
    url: "https://https://soleystudio.000webhostapp.com/api/member/face-Read.php",
