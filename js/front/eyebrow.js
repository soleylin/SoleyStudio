...
$(function () {
  $.ajax({
    type: "GET",
    url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/member/eyebrow-Read.php",
    dataType: "json",
    async: false,
    success: showdataProduct,
    error: function () {
      Swal.fire("系統串接錯誤！ - member/eyebrow-Read.php");
    },
  });
...
function drawTable(page) {
  ...
  newData[page].forEach(function (item) {
    var strHTML =
      '<div class="col-md-6 col-lg-4 col-xl-3"><div class="s2_box ms-auto me-auto"><div class="s2_bgbox"></div><div class="s2_img"><img src="/project/image/admin/product/' +
      item.image +
