...
$(function () {
  ...
  $.ajax({
    type: "POST",
    url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/member/member-Read.php",
  ...
  $.ajax({
    type: "POST",
    url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/member/memberReserve-Read.php",
    data: JSON.stringify(dataJSON),
    dataType: "json",
    async: false,
