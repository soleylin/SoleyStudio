  ...
  $("#mybody #delete_btn").click(function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: "POST",
          url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/faceItem/faceItem-Delete.php",
          data: JSON.stringify(dataJSON),
          dataType: "json",
          success: showdata_delete,
          error: function () {
            Swal.fire(
              "error-- manager/faceItem/faceItem-Delete.php"
            );
          },
        });
      }
