...
$(function () {
  ...
  $("#modal_update_btn").click(function () {
    if (flag_tel) {
      ...
      $.ajax({
        type: "POST",
        url: "https://soleystudio.000webhostapp.com/api/manager/reserve/reserve-Update.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
      ...
      $.ajax({
        type: "POST",
        url: "https://soleystudio.000webhostapp.com/api/manager/reserve/reserveDeposit-Update.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
        success: showdataReserve_upd,
        error: function () {
...
function update_data() {
  ...
  $.ajax({
    type: "GET",
    url: "https://soleystudio.000webhostapp.com/api/manager/reserve/reserve-Read.php",
    dataType: "json",
    async: false,
