...
$(function () {
  ...
  $("#modal_update_btn").click(function () {
    if (flag_tel) {
      ...
      $.ajax({
        type: "POST",
        url: "https://http://soleystudio.infinityfreeapp.com/api/manager/reserve/reserve-Update.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
      ...
      $.ajax({
        type: "POST",
        url: "https://http://soleystudio.infinityfreeapp.com/api/manager/reserve/reserveDeposit-Update.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
        success: showdataReserve_upd,
        error: function () {
