  ...
  $("body").on("click", "#mybody #delete_btn", function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: "POST",
          url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/reserve/reserveTime-Delete.php",
...
function read() {
  $.ajax({
    type: "GET",
    url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/reserve/reserveTime-Read.php",
    dataType: "json",
    async: false,
