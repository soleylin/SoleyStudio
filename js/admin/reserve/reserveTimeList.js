  ...
  $("body").on("click", "#mybody #delete_btn", function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: "POST",
          url: "https://soleystudio.000webhostapp.com/api/manager/reserve/reserveTime-Delete.php",
...
function showdata_delete(data) {
  if (data.state) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        location.href = "https://soleystudio.000webhostapp.com/admin/reserveTime.html";
      }
    });
  }
}
