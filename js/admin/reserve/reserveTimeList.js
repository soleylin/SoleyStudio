  ...
  $("body").on("click", "#mybody #delete_btn", function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: "POST",
          url: "http://soleystudio.infinityfreeapp.com/api/manager/reserve/reserveTime-Delete.php",
...
function read() {
  $.ajax({
    type: "GET",
    url: "http://soleystudio.infinityfreeapp.com/api/manager/reserve/reserveTime-Read.php",
    dataType: "json",
    async: false,
