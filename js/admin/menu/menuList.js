...
$(function () {
  $.ajax({
    type: "GET",
    url: "http://https://soleystudio.000webhostapp.com/api/manager/menu/menu-Read.php",
    dataType: "json",
    async: false,
  ...
  $("body").on("click", "#mybody #delete_btn", function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: "POST",
          url: "http://https://soleystudio.000webhostapp.com/api/manager/menu/menu-Delete.php",
