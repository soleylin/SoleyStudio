...
$(function () {
  ...
  $("#modal_add_btn").click(function () {
    ...
    if (flag_no && flag_item && flag_name && flag_image) {
      ...
      $.ajax({
        type: "POST",
        url: "http://https://soleystudio.000webhostapp.com/api/manager/image/productImage-Create.php",
        data: formdata,
        dataType: "json",
        cache: false,
        contentType: false,
...
function showdataImage(data) {
  ...
  $.ajax({
    type: "POST",
    url: "http://https://soleystudio.000webhostapp.com/api/manager/product/product-Create.php",
