...
$(function () {
  ...
  $("body").on("click", "#mybody #update_btn", function () {
    ...
    $("#upd_prevImg").attr(
      "src",
      "http://192.168.10.60/project/image/admin/product/" +
        $(this).data("image")
    );
  ...
  $("#modal_update_btn").click(function () {
    ...
    if (flag_image == "Y") {
      ...
      $.ajax({
        type: "POST",
        url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/image/productImage-Create.php",
        data: formdata,
        dataType: "json",
        cache: false,
        contentType: false,
      ...
      $.ajax({
        type: "POST",
        url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/product/product-Update.php",
...
function update_data() {
  ...
  $.ajax({
    type: "POST",
    url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/product/product-Read.php",
    data: JSON.stringify(dataJSON),
    dataType: "json",
    async: false,
