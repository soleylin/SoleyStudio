...
$(function () {
  ...
  $("#modal_update_btn").click(function () {
    ...
    if (flag_image == "Y") {
      ...
      $.ajax({
        type: "POST",
        url: "http://soleystudio.infinityfreeapp.com/api/manager/image/productImage-Create.php",
        data: formdata,
        dataType: "json",
        cache: false,
        contentType: false,
      ...
      $.ajax({
        type: "POST",
        url: "http://soleystudio.infinityfreeapp.com/api/manager/product/product-Update.php",
...
function update_data() {
  ...
  $.ajax({
    type: "POST",
    url: "http://soleystudio.infinityfreeapp.com/api/manager/product/product-Read.php",
    data: JSON.stringify(dataJSON),
    dataType: "json",
    async: false,
