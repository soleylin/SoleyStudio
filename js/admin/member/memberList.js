...
$(function () {
  ...
  $.ajax({
    type: "GET",
    url: "http://https://soleystudio.000webhostapp.com/api/manager/level/level-Read.php",
    dataType: "json",
    async: false,
  ...
  $("body").on("click", "#mybody #delete_btn", function () {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          type: "POST",
          url: "http://https://soleystudio.000webhostapp.com/api/manager/member/member-Delete.php",
  ...
  $(".submit").click(function () {
    if ($("#search").val() == "") {
      ...
      $.ajax({
        type: "POST",
        url: "http://https://soleystudio.000webhostapp.com/api/manager/member/member-Search.php",
        data: JSON.stringify(dataJSON),
        dataType: "json",
...
function read() {
  ...
  $.ajax({
    type: "POST",
    url: "http://https://soleystudio.000webhostapp.com/api/manager/member/member-Read.php",
    data: JSON.stringify(dataJSON),
    dataType: "json",
    async: false,
