...
$(function () {
  ...
  $("#modal_add_btn").click(function () {
    ...
    if (flag_image) {
      ...
      $.ajax({
        type: "POST",
        url: "https://http://soleystudio.infinityfreeapp.com/api/manager/image/feedbackImage-Create.php",
        data: formdata,
        dataType: "json",
        cache: false,
        contentType: false,
...
function showdataImage(data) {
  ...
  $.ajax({
    type: "POST",
    url: "https://http://soleystudio.infinityfreeapp.com/api/manager/feedback/feedback-Create.php",
