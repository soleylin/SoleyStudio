...
$(function () {
  ...
  $("#modal_add_btn").click(function () {
    ...
    if (flag_image) {
      ...
      $.ajax({
        type: "POST",
        url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/image/feedbackImage-Create.php",
        data: formdata,
        dataType: "json",
        cache: false,
        contentType: false,
...
function showdataImage(data) {
  ...
  $.ajax({
    type: "POST",
    url: "https://soleystudio.000webhostapp.com/SoleyStudio/api/manager/feedback/feedback-Create.php",
