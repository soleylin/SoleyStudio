...
$(function () {
  ...
  $("#modal_update_btn").click(function () {
    ...
    if (flag_itemContent && flag_price) {
      ...
      $.ajax({
        type: "POST",
        url: "http://https://soleystudio.000webhostapp.com/api/manager/record/record-Update.php",
...
function update_data() {
  ...
  $.ajax({
    type: "GET",
    url: "http://https://soleystudio.000webhostapp.com/api/manager/record/record-Read.php",
    dataType: "json",
    async: false,
